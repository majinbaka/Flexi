...
default`); mở rộng lên nhiều environment còn chờ ADR-002 (topology).
...
- Không bắt đầu multi-environment persistence trước ADR ownership/topology.
  Ownership đã chốt (ADR-001: Environment thuộc Application, MVP cardinality 1);
  **topology vẫn chưa** — ADR-002 còn Open và tiếp tục chặn Epic 11.
