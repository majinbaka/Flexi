...
dùng global prefix `/api` cho tới khi Story 0.2.1 (#76) chuyển. Response
envelope vẫn chờ ADR-004.
...
<DocumentationTable
  ...
  rows={[
    ...
    {
      id: 'versioning',
      decision: 'Response envelope nào?',
      proposal:
        'Base path đã chốt bởi ADR-003 (/api/v1, chuyển ở #76). Envelope còn chờ ADR-004.',
