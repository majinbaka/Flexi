...
- `docs/research/schema-per-tenant-implementation-guide.md` §1–4 -- source guide these patterns are narrowed/adapted from (it assumes Knex-only and schema-per-tenant for *everything*; neither holds here).
