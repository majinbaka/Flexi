...
- [x] `apps/frontend/.storybook/preview.tsx` -- import `../src/styles/tokens.css`, init i18n as `main.tsx` does -- previews render with real tokens/translations
...
- Reuses app's real tokens/i18n instead of a bare-component sandbox.
  [`preview.tsx:2`](../../../../../apps/frontend/.storybook/preview.tsx#L2)
