...
This PRD defines Flexi's Phase 1 internal tenant provisioning capability for the Super Admin surface and backend/API workflow. It is written for PM, engineering, architecture, QA, Ops, and downstream BMad workflows. Functional requirements are grouped by capability and numbered globally. Technical mechanics that should inform architecture and implementation are preserved in [addendum.md](/home/anhnv/Code/flexi/_bmad-output/planning-artifacts/prds/prd-Flexi-2026-08-21/addendum.md).

Primary source inputs:

- [SPEC.md](/home/anhnv/Code/flexi/_bmad-output/specs/spec-super-admin-tenant-onboarding/SPEC.md)
- [failure-modes.md](/home/anhnv/Code/flexi/_bmad-output/specs/spec-super-admin-tenant-onboarding/failure-modes.md)
- [schema-per-tenant-implementation-guide.md](/home/anhnv/Code/flexi/_bmad-output/planning-artifacts/schema-per-tenant-implementation-guide.md)
- [ARCHITECTURE-SPINE.md](/home/anhnv/Code/flexi/_bmad-output/planning-artifacts/architecture/architecture-flexi-2026-08-20/ARCHITECTURE-SPINE.md)
