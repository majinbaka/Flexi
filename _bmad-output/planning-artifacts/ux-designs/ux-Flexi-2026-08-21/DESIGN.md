...
updated: 2026-08-21
sources:
  - _bmad-output/specs/spec-super-admin-tenant-onboarding/SPEC.md
  - _bmad-output/specs/spec-super-admin-tenant-onboarding/failure-modes.md
  - _bmad-output/planning-artifacts/architecture/architecture-flexi-2026-08-20/ARCHITECTURE-SPINE.md
  - _bmad-output/planning-artifacts/schema-per-tenant-implementation-guide.md
