...
> **Historical UX design reference — verified status: 25/08/2026.** The
> shipped onboarding screens cover the core flow, but polling/provisioning
> detail and setup-token completion remain unfinished. Check current UI and
> stories before treating this document as an implementation statement.
