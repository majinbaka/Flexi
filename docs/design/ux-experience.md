...
> **Historical UX experience reference — verified status: 25/08/2026.** This
> is a planning/design record. Current UI and code take precedence; notably,
> the planned onboarding-attempt polling described below is not implemented.
